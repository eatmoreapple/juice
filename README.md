...
//go:generate juice impl --type UserRepository --config config.xml --namespace main.UserRepository --output interface_impl.go
...
```go
// Code generated by "juice impl --type UserRepository --config config.xml --namespace main.UserRepository --output interface_impl.go"; DO NOT EDIT.
